...
Begin VB.Form frm_client1 
   Caption         =   "Client 1 (Connects to Client 2)"
   ClientHeight    =   3915
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7215
...
'as you can see the Type is being set as Message when in fact its value is 0.
'like we defined in the ENUM definition. this is done automatically
...
Me.Show
frm_client2.Show 'show client2
Myname = "Client 01" 'set this clients name
txt_newnick = "Client 01"
Winsocket.Connect "127.0.0.1", 7293 'connect to client2
End Sub
